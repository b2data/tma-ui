...
export interface ModalProps
  ...
  dismissible?: boolean;
  /** Reference to the container element for the modal portal, enabling rendering outside the current DOM hierarchy. */
...
export const Modal = forwardRef<HTMLDivElement, ModalProps>(
  (
    ...
    const [portal, setPortal] = useState(portalContainer?.current);
    ...
    useEffect(() => {
      setPortal(portalContainer?.current);
    }, [portalContainer]);
