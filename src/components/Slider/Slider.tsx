...
import { SliderSteps, SliderThumb } from "./components";
import { useSlider } from "./hooks";
import { Touch, TouchEvent } from "@/components/Touch";

export interface SliderBaseProps
  extends Omit<
    HTMLAttributes<HTMLDivElement>,
    "value" | "defaultValue" | "onChange" | "onTouchEnd"
  > {
...
export interface SliderNoMultipleProps extends SliderBaseProps {
  ...
  /** Callback for when the slider finish changes. */
  onTouchEnd?: (value: number, event: TouchEvent) => void;
}
...
export interface SliderMultipleProps extends SliderBaseProps {
  ...
  /** Callback for when the slider finish changes. */
  onTouchEnd?: (value: [number, number], event: TouchEvent) => void;
}
