...
export const DeliveryOutIcon: FC<Icon> = ({
  size = 24,
  fill = "currentColor",
  ...props
}) => (
    ...
    <g style={{ transform: "translate(1px, -1px)" }}>
      ...
      <g style={{ transform: "translate(-2px, -2px) scale(0.9)" }}>
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m11.144267614285713 18.064771285714283 0 -7.342867328571428"
          strokeWidth="1.71"
        />
        <path
          stroke={fill}
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M13.931249999999999 13.461695228571429 11.14466565 10.675110878571427l-2.7865684285714285 2.78658435"
          strokeWidth="1.71"
        />
      </g>
    </g>
